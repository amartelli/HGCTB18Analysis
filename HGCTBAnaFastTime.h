...
#ifndef HGCTBAnaFastTime_h
#define HGCTBAnaFastTime_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   HGCTBAnaFastTime(TTree *tree=0);
   virtual ~HGCTBAnaFastTime();
...
#ifdef HGCTBAnaFastTime_cxx
//HGCTBAnaFastTime::HGCTBAnaFastTime(string infile, TTree *tree) : fChain(0) 
HGCTBAnaFastTime::HGCTBAnaFastTime(TTree *tree) : fChain(0) 
{
...
HGCTBAnaFastTime::~HGCTBAnaFastTime()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t HGCTBAnaFastTime::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t HGCTBAnaFastTime::LoadTree(Long64_t entry)
{
...
void HGCTBAnaFastTime::Init(TTree *tree)
{
...
Bool_t HGCTBAnaFastTime::Notify()
{
...
void HGCTBAnaFastTime::Show(Long64_t entry)
{
...
Int_t HGCTBAnaFastTime::Cut(Long64_t entry)
{
...
#endif // #ifdef HGCTBAnaFastTime_cxx
